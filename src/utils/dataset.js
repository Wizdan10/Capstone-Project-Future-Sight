...
let data= [
    {
        ...
        youtube: "https://www.youtube.com/watch?v=mRttyh1GQ5I&ab_channel=WebProgrammingUNPAS",
        salary: 20000000,
        imageProfesi: `${IT}`
    },
    {
...
function getProfesi(id){
    const foundedNote = data.find((data) => data.id === id);
    return foundedNote;
}

export { getAllProfesi, getProfesi };
// export default data;